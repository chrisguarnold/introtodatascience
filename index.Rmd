---
title: "PL 9248 Introduction to Data Science for Politics and IR"
...
dat22 <- read.csv("preparing_data/data/class_survey/lecture_survey_22.csv")
dat <- read.csv("preparing_data/data/class_survey/lecture_survey_23.csv")
# names(dat)
attach(dat)
