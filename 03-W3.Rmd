...
barplot(tsummer
			...
			, width = .35
			, las = 1
			, col = c(cardiffgrey, cardiffred, cardiffgold)
			, horiz = TRUE
			, border = NA
			, axes = TRUE)
text(14, .24, col ="white", labels = "Highest", cex = 2)
text(5, .24, col ="white", labels = "4", cex = 2)
