...
dat.treatment <- read.csv('experiment_w8/exp_w8_t.csv')
names(dat.treatment) <- c('timestamp','studyperweek','studyideal')
dat.control <- read.csv('experiment_w8/exp_w8_c.csv')
